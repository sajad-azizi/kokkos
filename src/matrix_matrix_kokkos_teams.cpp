//matrix_matrix_kokkos_teams.cpp
//may 21, 2025
...
int main(int argc, char* argv[]){
    ...
    Kokkos::initialize(argc, argv);
    {
        ...
        std::cout << "Memory space: " << Kokkos::DefaultExecutionSpace::memory_space::name() << std::endl;
        ...
        //multi with nested loop, team
        Kokkos::parallel_for("C=A*B, nestedLoop",policy,
            KOKKOS_LAMBDA(const team_policy::member_type& team){

                const int i = team.league_rank(); //outer index
